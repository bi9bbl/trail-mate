...
{
    if (!binding) return;
    ::ui::components::two_pane_nav::init(binding, make_adapter(screen));
}

void cleanup(Binding* binding)
{
    ::ui::components::two_pane_nav::cleanup(binding);
}

void on_ui_refreshed(Binding* binding)
{
    ::ui::components::two_pane_nav::on_ui_refreshed(binding);
}

void focus_filter(Binding* binding)
{
    ::ui::components::two_pane_nav::focus_filter(binding);
}

void focus_list(Binding* binding)
{
    ::ui::components::two_pane_nav::focus_list(binding);
}
