...
lv_obj_t* create_list_item_button(const String& text, intptr_t user_data, bool checked, bool disabled);
...
lv_obj_t* create_action_menu_button(lv_obj_t* parent, const char* text)
{
    ...
    lv_obj_set_size(btn, LV_PCT(100), kSecondaryButtonHeight);
...
void open_action_menu_modal()
{
    ...
    modal_prepare_group();
    const int modal_h = std::min(220, 56 + action_count * (kSecondaryButtonHeight + 4));
